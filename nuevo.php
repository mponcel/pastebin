          ...
          <form id="form1" name="form1" method="post" action="guardar.php">
            <table width="100%" border="0" cellspacing="3" cellpadding="3">
              ...
              <tr>
                ...
                <td class="labelizq"><input name="autor" type="text" id="autor" size="40"  /></td>
              </tr>
              <tr>
                <td class="labelder">Descripción</td>
                <td class="labelizq"><input name="descripcion" type="text" id="descripcion" size="80"  /></td>
              </tr>
              <tr>
                <td class="labelder">Código</td>
                <td class="labelizq"><label for="codigo"></label>
                  <textarea name="codigo" id="codigo" cols="80" rows="15"></textarea> </td>
              </tr>
              <tr>
